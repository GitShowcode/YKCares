...
- (void)drawRect:(CGRect)rect {
    ...
    for (int i = 0; i < pulsingCount; i++) {
        ...
        pulsingLayer.backgroundColor = [UIColor whiteColor].CGColor;//圈圈背景颜色，不设置则为透明。
        ...
        //雷达运行四个阶段不同的透明度。
        opacityAnimation.values = @[[NSNumber numberWithDouble:1.0],[NSNumber numberWithDouble:0.8],[NSNumber numberWithDouble:0.5],[NSNumber numberWithDouble:0.0]];
    ...
    CGRect thumbnailRect = CGRectMake(0, 0, 60, 60);
    ...
    thumbnailLayer.cornerRadius = 30;
