...
#define titleH 40
@implementation FamousTableVell
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.newtitleLabel.frame=CGRectMake(0, 60-titleH/2.0, SCREEN_WIDTH-0, titleH);
...
-(void)show{
    ...
    if (self.switchbtn.tag==110) {
        [UIView animateWithDuration:.3 animations:^{
            self.newtitleLabel.frame=CGRectMake(0, 0, SCREEN_WIDTH, titleH);
            
        }];
        
        [UIView animateWithDuration:.40 animations:^{
            self.bigcontentLabel.frame=CGRectMake(0, titleH, SCREEN_WIDTH, 120-titleH);
        ...
        [UIView animateWithDuration:0.3 animations:^{
            self.newtitleLabel.frame=CGRectMake(0, 60-titleH/2.0, SCREEN_WIDTH, titleH);
