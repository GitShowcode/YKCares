...
-(void)datasoucre{
    ...
    for (int i=0; i<titles.count; i++) {
        FamousObj *obj=[[FamousObj alloc] init];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    FamousTableVell *cell=[tableView dequeueReusableCellWithIdentifier:cellid];
    if (cell==nil) {
        cell=[[FamousTableVell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellid];
    }
    FamousObj *obj=self.mydatas[indexPath.row];
